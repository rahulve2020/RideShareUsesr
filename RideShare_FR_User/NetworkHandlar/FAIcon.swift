...
public extension String {
    ...
    func getFAType() -> FAType {
        var str = "\u{f2a2}"
        str = str.replacingOccurrences(of: "f2a2", with: self)
        let index = FAIcons.firstIndex(of: str)
...
public extension UITextField {
    ...
    func setRightViewFAIcon(icon: FAType, rightViewMode: UITextField.ViewMode = .always, textColor: UIColor = .black, backgroundColor: UIColor = .clear, size: CGSize? = nil) {
    ...
    func setLeftViewFAIcon(icon: FAType, leftViewMode: UITextField.ViewMode = .always, textColor: UIColor = .black, backgroundColor: UIColor = .clear, size: CGSize? = nil) {
        FontLoader.loadFontIfNeeded()
...
public extension UIImageView {
     ...
     */
     func setFAIconWithName(icon: FAType, textColor: UIColor, backgroundColor: UIColor = UIColor.clear, size: CGSize? = nil) {
        FontLoader.loadFontIfNeeded()
...
public extension UITabBarItem {
     ...
     func setFAIcon(icon: FAType, size: CGSize? = nil, textColor: UIColor = UIColor.black, backgroundColor: UIColor = UIColor.clear, selectedTextColor: UIColor = UIColor.black, selectedBackgroundColor: UIColor = UIColor.clear) {
        FontLoader.loadFontIfNeeded()
...
//            self(cgImage: image.cgImage!, scale: image.scale, orientation: image.imageOrientation)
     ...
     convenience init(bgIcon: FAType, bgTextColor: UIColor = .black, bgBackgroundColor: UIColor = .clear, topIcon: FAType, topTextColor: UIColor = .black, bgLarge: Bool? = true, size: CGSize? = nil) {
